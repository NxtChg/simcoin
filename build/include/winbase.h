...
QueryRecoveryAgentsA(
     ...
     OUT     PDWORD                          AgentCount,
     OUT     LPRECOVERY_AGENT_INFORMATIONA * RecoveryAgentInformation
     );
WINADVAPI
DWORD
WINAPI
QueryRecoveryAgentsW(
     ...
     OUT     PDWORD                          AgentCount,
     OUT     LPRECOVERY_AGENT_INFORMATIONW * RecoveryAgentInformation
     );
#ifdef UNICODE
#define QueryRecoveryAgents  QueryRecoveryAgentsW
#else
#define QueryRecoveryAgents  QueryRecoveryAgentsA
#endif // !UNICODE
